...
public class TripService implements ChildEventListener, ValueEventListener {
    private DatabaseReference mLanguagePreference;
    boolean isOnline = false;
    public TripService(String countryKey){
            mLanguagePreference = FirebaseDatabase.getInstance().getReference(".info/connected");
