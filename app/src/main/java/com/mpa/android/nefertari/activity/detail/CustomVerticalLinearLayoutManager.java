 ...
 * the measure pass.
 */
public class CustomVerticalLinearLayoutManager extends android.support.v7.widget.LinearLayoutManager {
    ...
    public CustomVerticalLinearLayoutManager(Context context) {
        super(context);
    }

    @SuppressWarnings("UnusedDeclaration")
    public CustomVerticalLinearLayoutManager(Context context, int orientation, boolean reverseLayout) {
