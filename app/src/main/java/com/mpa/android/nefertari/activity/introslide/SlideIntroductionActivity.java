package com.mpa.android.nefertari.activity.introslide;
...
import com.mpa.android.nefertari.SharedPref;
...
import com.mpa.android.nefertari.activity.login.LoginActivity;
...
public class SlideIntroductionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String Lang = sharedPref.getLang();
        Uts.getInstance().lang_prefix(Lang);
