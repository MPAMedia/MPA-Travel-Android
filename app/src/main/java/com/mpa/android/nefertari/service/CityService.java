...
public class CityService implements ChildEventListener, ValueEventListener {
    ...
    public List<FCity> getListCities(){
        ...
        Log.e("CityService : Lang",lang_prefix);
        ...
        for(int i = 0; i < getCount(); i++){
            ...
            fCity.setName((String)getItem(i).child("name"+lang_prefix).getValue());
            fCity.setVideoIntroUrl((String)getItem(i).child("videoIntroUrl"+lang_prefix).getValue());
            fCity.setIntro((String)getItem(i).child("intro"+lang_prefix).getValue());
            fCity.setBannerUrl((String)getItem(i).child("BannerUrl"+lang_prefix).getValue());
