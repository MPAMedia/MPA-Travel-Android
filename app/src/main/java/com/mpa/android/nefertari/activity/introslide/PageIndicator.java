...
public class PageIndicator extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    public void setIndicatorType(IndicatorType indicatorType) {
        ...
        if (mViewPager != null) {
            addIndicator(SlideIntroductionActivity.IMAGES_SLIDER.length);
//            addIndicator(mViewPager.getAdapter().getCount());
    ...
    private void addIndicator(int count) {
        ...
        updateIndicator(mViewPager.getCurrentItem()%SlideIntroductionActivity.IMAGES_SLIDER.length);
    }
    ...
    private void updateIndicator(int position) {
        if (mIndicatorTypeChanged || mActivePosition != position) {
            ...
            if (mIndicatorType == IndicatorType.CIRCLE) {
                ...
                LoggerFactory.d("updateIndicator at " + position);
    ...
    public void onPageSelected(int position) {
        updateIndicator(position % SlideIntroductionActivity.IMAGES_SLIDER.length);
    }
