...
public class MSharedPreferences {
    ...
    public static synchronized MSharedPreferences getInstance(Context c) {
        if (mSharedPreferences == null) {
            ...
            mSharedPreferences.securePreferences = SecurePreferences.getInstance(c, AppConstants.SECURE_PREFERENCE_FILE, AppConstants.SECURE_PREFERENCE_KEY, true);
        }
    ...
    public synchronized void clear() {
        try {
            ...
            mSharedPreferences.securePreferences.clear();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
