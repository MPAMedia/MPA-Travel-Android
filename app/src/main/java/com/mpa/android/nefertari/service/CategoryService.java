...
import com.mpa.android.nefertari.model.CityCategory;
import com.mpa.android.nefertari.model.FCityCategory;
...
//            }
    ...
    public List<CategoryInfo> getListCategoryInfoOfCity(String cityKey) {
        ...
        for (int i = 0; i < cityCategories.size(); i++) {
            ...
            CategoryInfo categoryInfo = TipApplication.getTipApplication().categoryInfoService.getCategoryByKey(cityCategories.get(i).getCategory_key());
            if (categoryInfo != null) {
                ...
                int item_index = TipApplication.getTipApplication().categoryInfoService.getIndexForKey(cityCategories.get(i).getCategory_key());
                categoryInfo.setName((String)TipApplication.getTipApplication().categoryInfoService.getItem(item_index).child("name"+lang_prefix).getValue());
                categoryInfo.setPriceUnit((String)TipApplication.getTipApplication().categoryInfoService.getItem(item_index).child("priceUnit"+lang_prefix).getValue());
